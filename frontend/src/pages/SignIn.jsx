...
const SignIn = () => {
  ...
  return (
    <div className="h-screen w-screen bg-[url('src/assets/bg-signIn.jpeg')]  bg-cover bg-top group flex flex-col items-center justify-center">
      {/* Use the AuthContainer component to create a centered container */}
      <AuthContainer>
        {/* Display the Logo component */}
              <h1 className="text-white font-bold text-4xl text-center">Socialify</h1>
